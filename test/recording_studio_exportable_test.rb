...
class RecordingStudioExportableTest < Minitest::Test
  def test_version_exists
    refute_nil ::RecordingStudioExportable::VERSION
  end

  def test_engine_exists
    assert_kind_of Class, ::RecordingStudioExportable::Engine
  end
  ...
  def test_dummy_topics_export_uses_columns_helper_payload
    view_path = File.expand_path("dummy/app/views/home/index.html.erb", __dir__)
    view_source = File.read(view_path)
  ...
  def test_dummy_components_docs_show_columns_payload
    view_path = File.expand_path("dummy/app/views/docs/components.html.erb", __dir__)
    view_source = File.read(view_path)
  ...
  def test_engine_does_not_ship_a_home_view
    view_path = File.expand_path("../app/views/recording_studio_exportable/home/index.html.erb", __dir__)
