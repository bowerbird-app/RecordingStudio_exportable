...
module RecordingStudioExportable
  ...
  #   RecordingStudioExportable.configuration.hooks.after_initialize do
  ...
  class Hooks
    ...
    def log_hook_error(error, event_name, _hook)
      ...
      Rails.logger.error "[RecordingStudioExportable::Hooks] Error in #{event_name} hook: #{error.class.name}"
    ...
    class << self
      ...
      # @return [Array] Results from all hooks
      def run(event_name, *)
        RecordingStudioExportable.configuration.hooks.run(event_name, *)
      end
      ...
      def run_around(event_name, context, &)
        RecordingStudioExportable.configuration.hooks.run_around(event_name, context, &)
      end
