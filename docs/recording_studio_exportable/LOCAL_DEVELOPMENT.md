...
```bash
git clone https://github.com/bowerbird-app/RecordingStudio_recording_studio_exportable.git
cd RecordingStudio_recording_studio_exportable
```
...
├── lib/
│   ├── recording_studio_exportable.rb       # Main entry point
│   ├── recording_studio_exportable/
