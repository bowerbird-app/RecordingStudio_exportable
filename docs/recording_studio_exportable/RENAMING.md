...
- **snake_case**: `recording_studio_exportable` → `new_gem_name`
- **PascalCase**: `RecordingStudioExportable` → `NewGemName`
...
- `docs/recording_studio_exportable/` - **Preserved as architectural reference**
  - These files document the original recording_studio_exportable structure
...
- What patterns and conventions come from the recording_studio_exportable
