...
> **📌 Note:** This documentation directory (`docs/recording_studio_exportable/`) is preserved during gem renaming and serves as architectural reference material. When you rename your gem, these files intentionally remain under `recording_studio_exportable` to document the original template structure.
...
```
recording_studio_exportable/
├── app/
│   ├── controllers/recording_studio_exportable/
│   └── views/recording_studio_exportable/
├── config/routes.rb
├── db/migrate/              # Engine migrations
├── lib/
│   ├── recording_studio_exportable.rb
│   ├── recording_studio_exportable/
│   │   ├── configuration.rb
│   │   ├── engine.rb
│   │   ├── version.rb
...
├── docs/                    # Documentation
└── recording_studio_exportable.gemspec
```
