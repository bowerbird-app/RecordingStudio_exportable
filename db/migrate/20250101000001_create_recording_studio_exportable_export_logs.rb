...
class CreateRecordingStudioExportableExportLogs < ActiveRecord::Migration[8.1]
  def change
    create_table :recording_studio_exportable_export_logs, id: :uuid do |t|
      ...
      t.index %i[context_recordable_type context_recordable_id], name: "idx_rs_exportable_logs_on_context_recordable"
      t.index %i[export_key status], name: "idx_rs_exportable_logs_on_export_key_and_status"
      t.index %i[actor_type actor_id], name: "idx_rs_exportable_logs_on_actor"
      t.index %i[impersonator_type impersonator_id], name: "idx_rs_exportable_logs_on_impersonator"
